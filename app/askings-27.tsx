...
export default function Asking27Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'skin_thin_severe',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'skin_thin_moderate',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'skin_thin_light',
    },
    {
      id: 'disagree',
      label: '아니다',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-28.tsx)
      router.push('/askings-28');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>피부 얇아짐과 저항력 이미지</Text>
          </View>
        </View>
