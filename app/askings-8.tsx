...
export default function Asking8Screen() {
  const [selectedAnswer, setSelectedAnswer] = useState<string | null>('agree');
  const currentPage = 8;
  const totalPages = 35;
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'agree',
      label: '그렇다',
      image: 'skin_sensitive_cosmetics',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'skin_normal_cosmetics',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-9.tsx)
      router.push('/askings-9');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>피부 민감성 화장품 이미지</Text>
          </View>
        </View>
        ...
        <View style={styles.answersContainer}>
          <View style={styles.answersGridTwo}>
