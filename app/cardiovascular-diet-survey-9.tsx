...
export default function CardiovascularDietSurvey9Screen() {
  ...
  const handleNext = () => {
    router.push('/cardiovascular-diet-survey-10');
  };
    ...
    <View style={styles.container}>
        ...
        <View style={styles.questionContainer}>
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              {t('cardiovascular.dietSurvey.questions.9')}
            </Text>
            <Text style={styles.questionDescription}>
              {t('cardiovascular.dietSurvey.questions.9Description')}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.bottomContainer}>
        <View style={styles.pageIndicator}>
          <Text style={styles.pageText}>9 / 34</Text>
        </View>
