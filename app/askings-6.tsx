...
export default function Asking6Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'skin_severe_trouble',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'skin_moderate_trouble',
    },
    {
      id: 'normal',
      label: t('askings.answers.normal'),
      image: 'skin_light_trouble',
    },
    {
      id: 'disagree',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-7.tsx)
      router.push('/askings-7');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>피부 거칠고 트러블 이미지</Text>
          </View>
        </View>
