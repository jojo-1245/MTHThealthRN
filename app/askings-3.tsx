...
export default function Asking3Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'eye_many_deep_wrinkles',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'eye_moderate_wrinkles',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'eye_few_light_wrinkles',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'eye_no_wrinkles',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-4.tsx)
      router.push('/askings-4');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>눈가, 입주위 주름 이미지</Text>
          </View>
        </View>
