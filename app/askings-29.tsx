...
export default function Asking29Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'face_sagging_severe',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'face_sagging_moderate',
    },
    {
      id: 'normal',
      label: t('askings.answers.normal'),
      image: 'face_sagging_light',
    },
    {
      id: 'disagree',
      label: t('askings.answers.disagree'),
      image: 'face_sagging_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-30.tsx)
      router.push('/askings-30');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>얼굴형태 변화와 입꼬리 처짐 이미지</Text>
          </View>
        </View>
