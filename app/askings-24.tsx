...
export default function Asking24Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'face_edge_spots_severe',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'face_edge_spots_moderate',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'face_edge_spots_light',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'face_edge_spots_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-25.tsx)
      router.push('/askings-25');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>얼굴 가장자리 갈색 반점 이미지</Text>
          </View>
        </View>
