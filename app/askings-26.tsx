...
export default function Asking26Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'agree',
      label: '그렇다',
      image: 'eye_crescent_pigmentation',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'eye_crescent_clear',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-27.tsx)
      router.push('/askings-27');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>눈꼬리 밑 반달모양 색소 이미지</Text>
          </View>
        </View>
