...
export default function Asking2Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'dry_wrinkled_skin',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'slightly_dry_skin',
    },
    {
      id: 'normal',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-3.tsx)
      router.push('/askings-3');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Ionicons name="person" size={60} color="#9CA3AF" style={styles.overlayIcon} />
