...
export default function CardiovascularDietSurvey6Screen() {
  const { t } = useTranslation();
  const [selectedOption, setSelectedOption] = useState(t('cardiovascular.dietSurvey.options.daily2'));
  ...
  const handleNext = () => {
    router.push('/cardiovascular-diet-survey-7');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.questionIcon}>
            <Ionicons name="egg" size={60} color="#8B5CF6" />
          </View>
        </View>
        ...
        <View style={styles.questionContainer}>
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              {t('cardiovascular.dietSurvey.questions.6')}
            </Text>
            <Text style={styles.questionDescription}>
              {t('cardiovascular.dietSurvey.questions.6Description')}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.bottomContainer}>
        <View style={styles.pageIndicator}>
          <Text style={styles.pageText}>6 / 34</Text>
        </View>
