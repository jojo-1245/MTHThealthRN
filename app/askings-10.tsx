...
export default function Asking10Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'skin_very_dull_messy',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'skin_dull_messy',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'skin_moderate_tone',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'skin_clear_tone',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-11.tsx)
      router.push('/askings-11');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>피부톤 칙칙하고 지저분한 이미지</Text>
          </View>
        </View>
