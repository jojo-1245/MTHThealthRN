...
export default function Asking12Screen() {
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-13.tsx)
      router.push('/askings-13');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>피부 건조하고 좁쌀 트러블 이미지</Text>
          </View>
        </View>
