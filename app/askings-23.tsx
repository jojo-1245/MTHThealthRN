...
export default function Asking23Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'seasonal_pigmentation_severe',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'seasonal_pigmentation_moderate',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'seasonal_pigmentation_light',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'seasonal_pigmentation_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-24.tsx)
      router.push('/askings-24');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>봄/여름 자외선과 피부 색소 침착 이미지</Text>
          </View>
        </View>
        ...
        <View style={styles.questionContainer}>
          <View style={styles.questionWrapper}>
            ...
            <Text style={styles.questionText}>
              자외선이 강한 봄과 여름에 피부 색소가 더 짙어져 보인다
            </Text>
          </View>
        </View>
