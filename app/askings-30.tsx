...
export default function Asking30Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'nasolabial_folds_severe',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'nasolabial_folds_moderate',
    },
    {
      id: 'normal',
      label: t('askings.answers.normal'),
      image: 'nasolabial_folds_light',
    },
    {
      id: 'disagree',
      label: t('askings.answers.disagree'),
      image: 'nasolabial_folds_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-31.tsx)
      router.push('/askings-31');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>팔자주름 이미지</Text>
          </View>
        </View>
