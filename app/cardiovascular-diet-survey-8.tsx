...
export default function CardiovascularDietSurvey8Screen() {
  ...
  const handleNext = () => {
    router.push('/cardiovascular-diet-survey-9');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.questionIcon}>
            <Ionicons name="fish" size={60} color="#8B5CF6" />
          </View>
        </View>
        ...
        <View style={styles.questionContainer}>
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              {t('cardiovascular.dietSurvey.questions.8')}
            </Text>
            <Text style={styles.questionDescription}>
              {t('cardiovascular.dietSurvey.questions.8Description')}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.bottomContainer}>
        <View style={styles.pageIndicator}>
          <Text style={styles.pageText}>8 / 34</Text>
        </View>
