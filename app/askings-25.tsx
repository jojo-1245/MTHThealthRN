...
export default function Asking25Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'cheek_pigmentation_severe',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'cheek_pigmentation_moderate',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'cheek_pigmentation_light',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'cheek_pigmentation_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-26.tsx)
      router.push('/askings-26');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>광대 뺨 주변 색소 침착 이미지</Text>
          </View>
        </View>
