...
export default function Asking4Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'skin_very_itchy_dry',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'skin_itchy_dry',
    },
    {
      id: 'normal',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-5.tsx)
      router.push('/askings-5');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>환절기 피부 가려움/건조 이미지</Text>
          </View>
        </View>
