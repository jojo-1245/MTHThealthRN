...
export default function CardiovascularDietSurvey22Screen() {
  ...
  const handleNext = () => {
    router.push('/cardiovascular-diet-survey-23');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.questionIcon}>
            <Ionicons name="tv" size={60} color="#8B5CF6" />
          </View>
        </View>
        ...
        <View style={styles.questionContainer}>
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              {t('cardiovascular.dietSurvey.questions.22')}
            </Text>
            <Text style={styles.questionDescription}>
              {t('cardiovascular.dietSurvey.questions.22Description')}
            </Text>
            <Text style={styles.questionNote}>
              {t('cardiovascular.dietSurvey.questions.22Note')}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.bottomContainer}>
        <View style={styles.pageIndicator}>
          <Text style={styles.pageText}>22 / 33</Text>
        </View>
