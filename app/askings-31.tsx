...
export default function Asking31Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'eyelid_sagging_severe',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'eyelid_sagging_moderate',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'eyelid_sagging_light',
    },
    {
      id: 'disagree',
      label: '아니다',
      image: 'eyelid_sagging_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-32.tsx)
      router.push('/askings-32');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>눈꺼풀 늘어짐과 눈 밑 지방 처짐 이미지</Text>
          </View>
        </View>
