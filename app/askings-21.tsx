...
export default function Asking21Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'blood_vessels_severe',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'blood_vessels_moderate',
    },
    {
      id: 'normal',
      label: t('askings.answers.normal'),
      image: 'blood_vessels_light',
    },
    {
      id: 'disagree',
      label: t('askings.answers.almostNone'),
      image: 'blood_vessels_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-22.tsx)
      router.push('/askings-22');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>얼굴에 실핏줄같은 혈관 이미지</Text>
          </View>
        </View>
