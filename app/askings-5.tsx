...
export default function Asking5Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'skin_very_oily_flaky',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'skin_oily_flaky',
    },
    {
      id: 'normal',
      label: '보통이다',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-6.tsx)
      router.push('/askings-6');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            <Ionicons name="time" size={120} color="#9CA3AF" />
            <Text style={styles.imageDescription}>오후 피부 번들거림/각질 이미지</Text>
          </View>
        </View>
