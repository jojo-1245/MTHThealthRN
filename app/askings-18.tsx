...
export default function Asking18Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'pores_severe_large',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'pores_moderate_large',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'pores_light_large',
    },
    {
      id: 'disagree',
      label: '아니다',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-19.tsx)
      router.push('/askings-19');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>모공과 피부 탄력 이미지</Text>
          </View>
        </View>
