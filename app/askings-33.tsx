...
export default function Asking33Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      ...
      image: 'mouth_wrinkles_severe',
    },
    {
      id: 'agree',
      label: t('askings.answers.agree'),
      image: 'mouth_wrinkles_moderate',
    },
    {
      id: 'normal',
      label: t('askings.answers.normal'),
      image: 'mouth_wrinkles_light',
    },
    {
      id: 'disagree',
      label: t('askings.answers.disagree'),
      image: 'mouth_wrinkles_none',
    },
  ];
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-34.tsx)
      router.push('/askings-34');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            ...
            <Text style={styles.imageDescription}>입가 주변 사선 주름 이미지</Text>
          </View>
        </View>
