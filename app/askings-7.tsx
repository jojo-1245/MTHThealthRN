...
export default function Asking7Screen() {
  ...
  const answerOptions: AnswerOption[] = [
    {
      id: 'very_much',
      label: '매우 그렇다',
      image: 'skin_severe_bumpy',
    },
    {
      id: 'agree',
      label: '그렇다',
      image: 'skin_moderate_bumpy',
    },
    {
      id: 'normal',
      label: '보통이다',
      image: 'skin_light_bumpy',
    },
    {
      id: 'disagree',
      label: '아니다',
  ...
  const handleNext = () => {
    if (selectedAnswer) {
      ...
      // 다음 페이지로 이동 (askings-8.tsx)
      router.push('/askings-8');
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionImageContainer}>
          <View style={styles.questionImagePlaceholder}>
            <Ionicons name="layers" size={120} color="#9CA3AF" />
            <Text style={styles.imageDescription}>피부표면 얇아지고 울긋불긋 이미지</Text>
          </View>
        </View>
